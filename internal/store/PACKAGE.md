...
- Transaction-list record filters match any active record within their dimension and compose independently at the containing transaction; anchored position/count reads do not hydrate transaction or journal-record rows.
