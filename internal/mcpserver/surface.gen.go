	...
	return []Operation{
		...
		},
		{
			...
			MCP: MCPOperation{
				...
				ReadOnly: false, Destructive: false, Idempotent: false, OpenWorld: false,
				InputSchema: json.RawMessage("{\"additionalProperties\":false,\"properties\":{\"body\":{\"additionalProperties\":false,\"properties\":{\"every\":{\"description\":\"Positive defer distance. For interval schedules this counts cadence units and defaults to the schedule's cadence; for date-rule schedules it counts natural schedule periods and defaults to 1.\",\"format\":\"int64\",\"minimum\":1,\"type\":\"integer\"},\"unit\":{\"description\":\"Cadence unit used for an interval-schedule offset. Must be omitted for date-rule schedules.\",\"enum\":[\"DAY\",\"WEEK\",\"MONTH\",\"YEAR\"],\"type\":\"string\"}},\"type\":\"object\"},\"recurring_definition_id\":{\"description\":\"Numeric identifier of the recurring definition to target or filter by.\",\"format\":\"int64\",\"minimum\":1,\"type\":\"integer\"}},\"required\":[\"recurring_definition_id\"],\"type\":\"object\"}"),
			},
			Input: InputDescriptor{
				Path: []ParameterDescriptor{
					{
		...
		},
		{
			...
			Description: "Use for exhaustive recurring-definition discovery, complete schedules, or resolving definition IDs. Keep results bounded with limit (1-500) and offset; q matches names, complete FQNs, FQN segments, and implicit-group descendants while preserving the requested sort. Use recurring_search_definitions for relevance-ranked discovery.",
			MCP: MCPOperation{
				Group: "recurring", Name: "list_definitions",
				ReadOnly: true, Destructive: false, Idempotent: true, OpenWorld: false,
				InputSchema: json.RawMessage("{\"additionalProperties\":false,\"properties\":{\"limit\":{\"description\":\"Maximum number of matching results to return, from 1 through 500; supply this to keep responses bounded.\",\"maximum\":500,\"minimum\":1,\"type\":\"integer\"},\"offset\":{\"description\":\"Zero-based number of matching results to skip.\",\"minimum\":0,\"type\":\"integer\"},\"q\":{\"description\":\"Case-insensitive fuzzy membership over definition names, complete FQNs, FQN segments, and matching implicit-group descendants; requested sort order is preserved.\",\"type\":\"string\"},\"sort\":{\"default\":\"fqn\",\"description\":\"Field used to sort matching results; defaults to `fqn`. `next_due_date` keeps missing dates last and uses ascending FQN and definition ID tie-breakers.\",\"enum\":[\"fqn\",\"next_due_date\",\"created_at\",\"updated_at\"],\"type\":\"string\"},\"sort_dir\":{\"default\":\"asc\",\"description\":\"Sort direction for matching results; defaults to `asc`.\",\"enum\":[\"asc\",\"desc\"],\"type\":\"string\"}},\"type\":\"object\"}"),
			},
			Input: InputDescriptor{
				Query: []ParameterDescriptor{
					{
		...
		},
		{
			...
			Description: "Use for exhaustive transaction-template discovery, full date-free defaults, or resolving template IDs. Keep results bounded with limit (1-500) and offset; q matches names, complete FQNs, FQN segments, and implicit-group descendants while preserving the requested sort, which defaults to ascending FQN. Use transaction_templates_search for relevance-ranked discovery.",
			MCP: MCPOperation{
				Group: "transaction_templates", Name: "list",
				ReadOnly: true, Destructive: false, Idempotent: true, OpenWorld: false,
				InputSchema: json.RawMessage("{\"additionalProperties\":false,\"properties\":{\"limit\":{\"description\":\"Maximum number of matching results to return, from 1 through 500; supply this to keep responses bounded.\",\"maximum\":500,\"minimum\":1,\"type\":\"integer\"},\"offset\":{\"description\":\"Zero-based number of matching results to skip.\",\"minimum\":0,\"type\":\"integer\"},\"q\":{\"description\":\"Case-insensitive fuzzy membership over template names, complete FQNs, FQN segments, and matching implicit-group descendants; the caller-requested sort is preserved, defaulting to ascending FQN.\",\"type\":\"string\"},\"sort\":{\"default\":\"fqn\",\"description\":\"Field used to sort matching results; defaults to `fqn`.\",\"enum\":[\"fqn\",\"created_at\",\"updated_at\"],\"type\":\"string\"},\"sort_dir\":{\"default\":\"asc\",\"description\":\"Sort direction for matching results; defaults to `asc`.\",\"enum\":[\"asc\",\"desc\"],\"type\":\"string\"}},\"type\":\"object\"}"),
			},
			Input: InputDescriptor{
				Query: []ParameterDescriptor{
					{
		...
		},
		{
			...
			Description: "Ranked, caller-bounded recurring-definition discovery for navigation. Supply context=navigation and a limit; use recurring_list_definitions for exhaustive canonical filtering, schedules, totals, and pagination.",
			MCP: MCPOperation{
				Group: "recurring", Name: "search_definitions",
				ReadOnly: true, Destructive: false, Idempotent: true, OpenWorld: false,
				InputSchema: json.RawMessage("{\"additionalProperties\":false,\"properties\":{\"context\":{\"enum\":[\"navigation\"],\"type\":\"string\"},\"exclude_ids\":{\"description\":\"Active selected leaf IDs to omit from candidates.\",\"items\":{\"format\":\"int64\",\"minimum\":1,\"type\":\"integer\"},\"type\":\"array\"},\"limit\":{\"maximum\":500,\"minimum\":1,\"type\":\"integer\"},\"parent_fqn\":{\"description\":\"Return only direct children of this hierarchy group; an empty value selects root children.\",\"type\":\"string\"},\"q\":{\"type\":\"string\"}},\"required\":[\"context\",\"limit\"],\"type\":\"object\"}"),
			},
			Input: InputDescriptor{
				Query: []ParameterDescriptor{
					{
		...
		},
		{
			...
			Description: "Ranked, caller-bounded transaction-template discovery for entry selection or navigation. Supply a typed context and limit; use transaction_templates_list for exhaustive canonical filtering, full defaults, totals, and pagination.",
			MCP: MCPOperation{
				Group: "transaction_templates", Name: "search",
				ReadOnly: true, Destructive: false, Idempotent: true, OpenWorld: false,
				InputSchema: json.RawMessage("{\"additionalProperties\":false,\"properties\":{\"compatible_shorthand\":{\"description\":\"Restrict transaction-entry candidates to templates compatible with this shorthand; omit for advanced entry.\",\"enum\":[\"spend\",\"income\",\"refund\",\"transfer\"],\"type\":\"string\"},\"context\":{\"enum\":[\"navigation\",\"transaction_entry\"],\"type\":\"string\"},\"exclude_ids\":{\"description\":\"Active selected leaf IDs to omit from candidates.\",\"items\":{\"format\":\"int64\",\"minimum\":1,\"type\":\"integer\"},\"type\":\"array\"},\"limit\":{\"maximum\":500,\"minimum\":1,\"type\":\"integer\"},\"parent_fqn\":{\"description\":\"Return only direct children of this hierarchy group; an empty value selects root children.\",\"type\":\"string\"},\"q\":{\"type\":\"string\"}},\"required\":[\"context\",\"limit\"],\"type\":\"object\"}"),
			},
			Input: InputDescriptor{
				Query: []ParameterDescriptor{
					{
