...
- Loads process-local runtime configuration from defaults, local config, environment variables, and CLI values.
- Owns source precedence for operational settings before runtime composition starts.

## Implicit Contracts

- Precedence is defaults < config file < environment < CLI values.
