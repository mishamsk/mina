...
- Active records within a transaction must be all cancelled or all non-cancelled; create, replace, and bulk posting-status updates reject mixed cancelled/non-cancelled outcomes.
