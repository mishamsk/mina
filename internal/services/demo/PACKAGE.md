...
- The injected atomic boundary holds reference, exchange-rate, and occurrence coordination through the entire transaction-scoped seed, commit, and main-cache invalidation, and propagates its lease context into every service call.
