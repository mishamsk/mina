...
- Implemented storage behavior:
  - Runtime opens an in-memory DuckDB process database and selects either an attached accounting database file or the in-memory accounting database with configurable schema fallback.
