...
- Implemented runtime/demo behavior:
  ...
  - `mina serve --demo` seeds six calendar months of realistic, current-date-anchored demo transactions, recurring definitions, and expected occurrences for new in-memory state or new file-backed schemas; CLI and REST callers may supply an exact anchor date.
