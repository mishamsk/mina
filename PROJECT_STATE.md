...
- Transactions support record-currency and other record/transaction filters, pagination, date anchoring, free-text search, and stable initiated/created/updated ordering; full replacement; independent derived class, shape, role, and display metadata; dry-run classification; and record-level bulk category, tag, member, account, settlement, and reconciliation updates.
