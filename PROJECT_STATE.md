...
- Implemented web UI behavior:
  ...
  - Transactions and register embeddings show EXPECTED recurring occurrences inline by default with overdue emphasis, a URL-backed hide control, and confirm/dismiss row actions; the Recurring screen remains available for occurrence review.
