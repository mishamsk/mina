...
const buttonVariants = cva(
  "group/button font-heading inline-flex shrink-0 items-center justify-center border-2 border-[var(--border-ink)] bg-clip-padding text-sm font-semibold whitespace-nowrap uppercase shadow-[var(--shadow-pixel)] transition-[transform,box-shadow,background-color,color] duration-150 ease-[steps(2)] select-none active:not-aria-[haspopup]:translate-x-1 active:not-aria-[haspopup]:translate-y-1 active:not-aria-[haspopup]:shadow-none disabled:pointer-events-none disabled:translate-x-0 disabled:translate-y-0 disabled:opacity-50 disabled:shadow-none aria-invalid:border-destructive [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
