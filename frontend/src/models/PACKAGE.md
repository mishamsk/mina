...
- Entity-chip mutations require row-renderable filters; Advanced expressions remain unchanged until Clear. Exact entity activation narrows a same-field hierarchy scope instead of joining the scope's alternatives, and same-text human and stable-ID predicates remain distinct alternatives.
