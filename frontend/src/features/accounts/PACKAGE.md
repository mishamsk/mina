...
- Account and group registers load records directly; transaction listing is non-mutating, while register queries exclude expected transactions from accounting views.
