...
- List-delete dismissal returns focus to its opener, while successful list deletion moves focus to the visible search field or compact Controls trigger, and side-panel confirmation restores its delete control.
