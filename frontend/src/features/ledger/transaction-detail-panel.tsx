...
export const TransactionDetailPanel = ({
  ...
  return (
    <aside
      ...
      className="bg-card compact-shell:bottom-[calc(4.75rem+env(safe-area-inset-bottom))] fixed top-4 right-4 bottom-4 z-50 flex w-[min(760px,calc(100vw-2rem))] max-w-full flex-col border-2 border-[var(--border-ink)] shadow-[var(--shadow-pixel)]"
