 ...
 */
export const listTransactions = <ThrowOnError extends boolean = false>(options?: Options<ListTransactionsData, ThrowOnError>): RequestResult<ListTransactionsResponses, unknown, ThrowOnError> => (options?.client ?? client).get<ListTransactionsResponses, unknown, ThrowOnError>({ url: '/api/transactions', ...options });
