 ...
 */
export const listBackgroundOperationRuns = <ThrowOnError extends boolean = false>(options: Options<ListBackgroundOperationRunsData, ThrowOnError>): RequestResult<ListBackgroundOperationRunsResponses, ListBackgroundOperationRunsErrors, ThrowOnError> => (options.client ?? client).get<ListBackgroundOperationRunsResponses, ListBackgroundOperationRunsErrors, ThrowOnError>({ url: '/api/background-operations/{operation_id}/runs', ...options });
 ...
 */
export const listExchangeRateLoadingRuns = <ThrowOnError extends boolean = false>(options?: Options<ListExchangeRateLoadingRunsData, ThrowOnError>): RequestResult<ListExchangeRateLoadingRunsResponses, ListExchangeRateLoadingRunsErrors, ThrowOnError> => (options?.client ?? client).get<ListExchangeRateLoadingRunsResponses, ListExchangeRateLoadingRunsErrors, ThrowOnError>({ url: '/api/background-operations/exchange-rate-loading/runs', ...options });
 ...
 */
export const listDatabaseBackupRuns = <ThrowOnError extends boolean = false>(options?: Options<ListDatabaseBackupRunsData, ThrowOnError>): RequestResult<ListDatabaseBackupRunsResponses, ListDatabaseBackupRunsErrors, ThrowOnError> => (options?.client ?? client).get<ListDatabaseBackupRunsResponses, ListDatabaseBackupRunsErrors, ThrowOnError>({ url: '/api/background-operations/database-backup/runs', ...options });
