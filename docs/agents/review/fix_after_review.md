...
- Do not start another review-loop or perform issue, plan, or fleet orchestration; this agent is one stage of an outer review loop. Follow the repository's formatting and per-commit validation requirements for the affected change, including its documentation and tooling exceptions.
