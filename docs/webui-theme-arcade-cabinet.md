...
- Focus: 2px solid `--ring` outline with 2px offset on keyboard-operable controls, including programmatically focused controls. Passive headings and surfaces used as programmatic focus destinations have no focus styling. Never restyled per component.
